...
def detect_base_metrics(columns):
    """
    Detect base metric prefixes like:
    NUM_HPV_VACCINATION_9_17
    NUM_SHINGLES_VACCINATION_65_PLUS
    """
    base_metrics = set()
...
def compile_contact_validity(df):
    ...
    # Pivot so metric column becomes the numeric column
